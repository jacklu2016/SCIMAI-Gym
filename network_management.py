...
class NetInvMgmtMasterEnv(gym.Env):
    ...
    def _create_default_graph(self):
        ...
        self.graph.add_edges_from([
            ...
            (4, 1, {'p': 2.000, 'b': 0.100, # p: price charged by retailer, b: backlog/lost sale cost
                    ...
                    'dist_param': {'lam': 20}}),
            (4, 2, {'L': 5, 'p': 1.500, 'g': 0.010}), # L: Lead Time, p: purchase cost for receiver, g: pipeline holding cost
            (4, 3, {'L': 3, 'p': 1.600, 'g': 0.015}),
            (5, 4, {'L': 9, 'p': 0.700, 'g': 0.005})
        ])
